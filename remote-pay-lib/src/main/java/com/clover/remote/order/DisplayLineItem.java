...
public final class DisplayLineItem implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public java.util.List<com.clover.remote.order.DisplayModification> getModifications() {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<DisplayLineItem> {
    ...
    modifications {
      @Override
      public Object extractValue(DisplayLineItem instance) {
        return instance.genClient.extractListRecord("modifications", com.clover.remote.order.DisplayModification.JSON_CREATOR);
      }
    },
    refunded {
      @Override
  ...
  private GenericClient<DisplayLineItem> genClient = new GenericClient<DisplayLineItem>(this);
   ...
   */
  public DisplayLineItem setDiscounts(java.util.List<com.clover.remote.order.DisplayDiscount> discounts) {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public DisplayLineItem setModifications(java.util.List<com.clover.remote.order.DisplayModification> modifications) {
