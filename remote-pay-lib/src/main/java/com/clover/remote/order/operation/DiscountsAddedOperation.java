...
public final class DiscountsAddedOperation implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<DiscountsAddedOperation> {
    ids {
      @Override
      public Object extractValue(DiscountsAddedOperation instance) {
  ...
  private GenericClient<DiscountsAddedOperation> genClient = new GenericClient<DiscountsAddedOperation>(this);
   ...
   */
  public DiscountsAddedOperation setIds(java.util.List<String> ids) {
   ...
   */
  public DiscountsAddedOperation setOrderId(String orderId) {
