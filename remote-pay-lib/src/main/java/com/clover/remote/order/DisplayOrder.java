...
public final class DisplayOrder implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  public java.util.List<com.clover.remote.order.DisplayDiscount> getDiscounts() {
    return genClient.cacheGet(CacheKey.discounts);
  }

  public java.util.List<com.clover.remote.order.DisplayLineItem> getLineItems() {
   ...
   */
  public java.util.List<com.clover.remote.order.DisplayPayment> getPayments() {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<DisplayOrder> {
    ...
    discounts {
      @Override
      public Object extractValue(DisplayOrder instance) {
        return instance.genClient.extractListRecord("discounts", com.clover.remote.order.DisplayDiscount.JSON_CREATOR);
      }
    },
    lineItems {
      @Override
      public Object extractValue(DisplayOrder instance) {
        return instance.genClient.extractListRecord("lineItems", com.clover.remote.order.DisplayLineItem.JSON_CREATOR);
      }
    },
    amountRemaining {
      @Override
    ...
    payments {
      @Override
      public Object extractValue(DisplayOrder instance) {
        return instance.genClient.extractListRecord("payments", com.clover.remote.order.DisplayPayment.JSON_CREATOR);
      }
    },
    ;
  }

  private GenericClient<DisplayOrder> genClient = new GenericClient<DisplayOrder>(this);
   ...
   */
  public DisplayOrder setDiscounts(java.util.List<com.clover.remote.order.DisplayDiscount> discounts) {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public DisplayOrder setLineItems(java.util.List<com.clover.remote.order.DisplayLineItem> lineItems) {
   ...
   * Nulls in the given List are skipped. List parameter is copied, so it will not reflect any changes, but objects inside it will.
   */
  public DisplayOrder setPayments(java.util.List<com.clover.remote.order.DisplayPayment> payments) {
