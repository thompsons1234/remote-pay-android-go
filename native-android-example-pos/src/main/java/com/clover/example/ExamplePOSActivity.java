...
import com.clover.sdk.v3.remotemessage.TipAddedMessage;
...
import com.clover.sdk.v3.remotepay.RetrieveDeviceStatusResponse;
...
import static com.clover.example.StartupActivity.EXAMPLE_APP_NAME;
...
public class ExamplePOSActivity extends Activity implements CurrentOrderFragment.OnFragmentInteractionListener,
  ...
  PaymentConfirmationListener paymentConfirmationListener = new PaymentConfirmationListener() {
    ...
    public void onRejectClicked(Challenge challenge) { // Reject payment and send the challenge along for logging/reason
      cloverConnector.rejectPayment(ExamplePOSActivity.this, currentPayment, challenge);
    ...
    public void onAcceptClicked(final int challengeIndex) {
      if (challengeIndex == currentChallenges.size() - 1) { // no more challenges, so accept the payment
        cloverConnector.acceptPayment(ExamplePOSActivity.this, currentPayment);
        currentChallenges = null;
        currentPayment = null;
  ...
  IPaymentConnectorListener ccListener;
  ...
  public void initialize() {
    ...
    if (ccListener == null) {
      ccListener = new IPaymentConnectorListener() {
...
*/
  ...
  public void captureCardClick(View view) {
    cloverConnector.vaultCard(ExamplePOSActivity.this, store.getCardEntryMethods());
  }
  ...
  public void onManualRefundClick(View view) {
    ...
    try {
      ...
      cloverConnector.manualRefund(ExamplePOSActivity.this, request);
  ...
  public void preauthCardClick(View view) {
    ...
    cloverConnector.preAuth(ExamplePOSActivity.this, request);
  }
  ...
  public void onReadCardDataClick(View view) {
    ...
    cloverConnector.readCardData(ExamplePOSActivity.this, readCardDataRequest);
  }
