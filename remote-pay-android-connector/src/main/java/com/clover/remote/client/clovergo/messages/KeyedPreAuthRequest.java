...
public class KeyedPreAuthRequest extends PreAuthRequest implements KeyedRequest {
  ...
  public KeyedPreAuthRequest(long amount, String externalId, String cardNumber, String expDate, String cvv) {
