...
public class DefaultCloverDevice extends CloverDevice implements CloverTransportObserver {
    ...
    {
        if(message == null) {
            ALog.d("Message is null", null, this);
            return;
        }
        ALog.d(message.method, null, message);
        if(message == null || message.method == null) {
            ALog.e(this, new IllegalArgumentException("Invalid message: " + (message == null ? "" : message.toString())), null);
            return;
        }
