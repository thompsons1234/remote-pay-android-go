        ...
        getActivity().runOnUiThread(new Runnable(){
          @Override public void run() {
            if(pendingPayments == null) {
              Toast.makeText(view.getContext(), "Get pending payments failed.", Toast.LENGTH_LONG).show();
            } else {
              Toast.makeText(view.getContext(), "Got back " + pendingPayments.size() + " pending payment(s)", Toast.LENGTH_LONG).show();
            }
